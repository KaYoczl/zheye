      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button @click="onClose" type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{cancelText}}</button>
            <button @click="onConfirm" type="button" class="btn btn-primary">{{confirmText}}</button>
          </div>
        </div>
      </div>
    </div>
